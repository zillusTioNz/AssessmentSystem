...
<dx:ContentControl runat="server">
                                                    <dx:ASPxGridView runat="server" KeyFieldName="id" AutoGenerateColumns="False" ID="gvFileDetail" DataSourceID="SqlDocuments" OnRowDeleting="gvFileDetail_RowDeleting" ClientInstanceName="Gridview"><Columns>
