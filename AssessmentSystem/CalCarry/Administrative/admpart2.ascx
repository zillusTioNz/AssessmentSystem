...
<dx:ContentControl runat="server">
                                                    <dx:ASPxGridView runat="server" KeyFieldName="id" AutoGenerateColumns="False" DataSourceID="SqlDocuments" ID="gvFileDetail"><Columns>
...
<dx:ContentControl runat="server">
                                                    <dx:ASPxUploadControl runat="server" UploadMode="Auto" ShowAddRemoveButtons="True" ShowProgressPanel="True" ShowUploadButton="True" Width="280px" ID="ASPxUploadControl1"></dx:ASPxUploadControl>
...
<asp:Parameter DefaultValue="13" Name="TableNameID"></asp:Parameter>
</SelectParameters>
<UpdateParameters>
<asp:Parameter Name="Iden" Type="Int32"></asp:Parameter>
<asp:Parameter Name="TableNameID"></asp:Parameter>
