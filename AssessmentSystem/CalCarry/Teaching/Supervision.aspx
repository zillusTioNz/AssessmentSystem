...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <p>
        <dx:ASPxGridView ID="gvSupervision" runat="server" AutoGenerateColumns="False" DataSourceID="SqlSupervision" KeyFieldName="id" OnCustomUnboundColumnData="gvSupervision_CustomUnboundColumnData" OnRowDeleting="gvSupervision_RowDeleting" ClientInstanceName="MasterGrid">
	...
	MasterGrid.Refresh();
        ...
        <asp:SqlDataSource ID="SqlSupervision" runat="server" ConnectionString="<%$ ConnectionStrings:AssessmentSystem %>" DeleteCommand="DELETE FROM [Supervision] WHERE [id] = @original_id" InsertCommand="INSERT INTO [Supervision] ([StdNumber], [UserName], [DurationID]) VALUES (@StdNumber, @UserName, @DurationID)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [Supervision] WHERE (([UserName] = @UserName) AND ([DurationID] = @DurationID))" UpdateCommand="UPDATE [Supervision] SET [StdNumber] = @StdNumber, [UserName] = @UserName, [DurationID] = @DurationID WHERE [id] = @original_id">
            <DeleteParameters>
